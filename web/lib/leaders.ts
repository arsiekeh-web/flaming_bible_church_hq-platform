...
export const LEADERS: Record<string, Leader & { photo: string }> = {
  ...
  pastor: {
    ...
    role: 'Head Pastor',
    bio: 'Rev. Olamide Macculey is the Head Pastor ot Flaming Bible Church HQ. He studied at the University of Newcastle-upon-Tyne. He serves as the School Manager for Flaming High School, overseeing administration and institutional development.
}
